                                ...
                                <tbody>
                                    @foreach ($sliders as $slider)
                                        <tr>
                                            <td>  <ul class="list-inline">
                                                <li class="list-inline-item">
                                                    <img alt="Avatar" class="" width="100px"
                                        ...
                                        <td>{{ $slider->name }}</td>
                                            ...
                                            <td>
                                                <a href="{{ $slider->url}}" target="_blank">{{ Str::limit($slider->url,40) }}</a>
                                            </td>
                                            ...
                                            <td class="project-actions text-right">
                                                    ...
                                                    <a class="btn btn-outline-info btn-sm mb-1"
                                                        href="{{ route('edit_slider', $slider->id) }}" style="width:110px">
                                                ...
                                                <form method="POST" action="{{ route('delete_slider', $slider->id) }}">
                                                    @csrf

                                                    <button type="submit" id="delete_record_" onclick="delete_record({{$slider->id}})" class="btn btn-outline-danger btn-sm show_confirm"

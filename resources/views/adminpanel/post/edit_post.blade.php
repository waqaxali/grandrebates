              ...
              <div class="card-body">
                <div class="tab-content">
                  ...
                  <div class="tab-pane active" id="settings">
                    <form class="form-horizontal" method="post" action="{{route('update_post',$current_post->id)}}" enctype="multipart/form-data">
@csrf
                           ...
                           <small>Appends a suffix to the URL</small></label>
                            <div class="col-sm-12">
                              <select class="form-control" name="category_id">
                                ...
                                <option value="{{$category->id}}" {{$category->id ==$current_post->category_id  ? 'selected' : ''}}>{{$category->name}}</option>
                                @endforeach
                            </select>
                            </div>
                          </div>
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-12">
                          <input type="text" name="name" value="{{$current_post->name}}" class="form-control" id="inputName" placeholder="e.g. Apparel">
                        </div>
                      </div>
					  ...
					  <div class="form-group row">
                        ...
                        <div class="col-sm-12">
                           <textarea id="summernote" name="description"  class="form-control" style="min-height:200px">{{$current_post->description}}</textarea>
                        </div>
                      </div>
                      ...
                      <div class="input-group-append">
						...
						<div class="col-sm-4">
                            ...
                            <img class="img-fluid mb-3" id="img1" src="{{asset('images/'.$current_post->featured_image)}}" alt="Photo">
                            @else
                            <img class="img-fluid mb-3" id="img1" src="{{asset('avatar/upload.png')}}" alt="Photo">
                            @endif
...
<small>Appends a suffix to the URL</small></label>
                        <div class="col-sm-12">
                          <input type="text" class="form-control" id="" value="{{$current_post->meta_keyword}}" name="meta_keyword" placeholder="meta tag">
                        </div>
                      </div>

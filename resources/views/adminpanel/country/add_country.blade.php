        ...
        <div class="content-header">
            <div class="container">
                ...
                <div class="row mb-1 ml-1 mt-3">
                    <a href="{{route('countries')}}" class="btn btn-success">Back to countries</a>
                    </div>
            </div><!-- /.container-fluid -->
        </div>
            ...
            <div class="col-md-9">
                <div class="card">
                    <div class="card-header p-2">
                        <h5 class="pt-2 pl-2">Add New Country...<h5>
                    </div><!-- /.card-header -->
                    <div class="card-body">
                        <div class="tab-content">
                            ...
                            <div class="tab-pane active" id="settings">
                                <form class="form-horizontal " method="post"
                                    action="{{ route('save_country') }}"enctype="multipart/form-data">
                                    @csrf
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-12">
                                            <input type="text" name="country_name"
                                                ...
                                                id="inputName" placeholder="e.g. Apparel" value="{{ old('country_name') }}">
                                            @error('country_name')
